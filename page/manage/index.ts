...
import { createManageAiProvidersRoute } from './pages/ai'
...
export const createManageRoute = (deps: ManageRouteDeps) => {
    ...
    app.route(
        ...
        createManageOverviewRoute({
            ...
            aiConnectionService: deps.aiConnectionService,
    ...
    app.route('/ai/providers', createManageAiProvidersRoute({ getSession: deps.getSession, aiConnectionService: deps.aiConnectionService }))
