...
> **`db:push` 대기 3건**: `mail_messages` unique 3열(D-05, 1차) · `calendar_subscription.user_id` unique(R-25, 3차) · P-02 인덱스 8종 추가 + 중복 3종 제거(4차). 전부 push 전까지 DB 에 반영되지 않는다.
